...
namespace stylizer::graphics::webgpu {
	...
	struct command_encoder_base : public Tapi_return { STYLIZER_GRAPHICS_GENERIC_AUTO_RELEASE_SUPPORT(command_encoder_base);
		...
		static Twebgpu_return create(graphics::device& device, bool one_shot = false, const std::string_view label = "Stylizer Command Encoder") { STYLIZER_THROW("Not implemented yet!"); }

		template<typename Tfunc>
		Twebgpu_return& defer(Tfunc&& func) { STYLIZER_THROW("Not implemented yet!"); }
