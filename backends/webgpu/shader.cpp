...
namespace stylizer::graphics::webgpu {
	...
	shader shader::create_from_wgsl(graphics::device& device_, const std::string_view wgsl, const std::string_view label /* = "Stylizer Shader" */) {
	...
	shader shader::create_from_session(graphics::device& device, shader::stage stage, slcross::session session, const std::string_view entry_point /* = "main" */, const std::string_view label /* = "Stylizer Shader" */) {
		auto wgsl = slcross::wgsl::generate(session, entry_point);
		return create_from_wgsl(device, wgsl, label);
	}

	shader shader::create_from_spirv(graphics::device& device, shader::stage stage, spirv_view spirv, const std::string_view entry_point /* = "main" */, const std::string_view label /* = "Stylizer Shader" */) {
	...
	shader shader::create_from_source(graphics::device& device, language lang, shader::stage stage, const std::string_view source, const std::string_view entry_point /* = "main" */, const std::string_view label /* = "Stylizer Shader" */) {
