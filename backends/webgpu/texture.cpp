...
namespace stylizer::api::webgpu {
	...
	inline enum texture_view::create_config::aspect from_webgpu(WGPUTextureAspect aspect){
		...
		default:
			STYLIZER_API_THROW(std::string("Failed to find texture aspect: ") + magic_enum::enum_name(aspect));
		}
		std::unreachable();
	}
	...
	inline texture::address_mode from_webgpu(WGPUAddressMode mode) {
		...
		default:
			STYLIZER_API_THROW(std::string("Failed to find address mode: ") + magic_enum::enum_name(mode));
		}
		std::unreachable();
	}
