...
namespace stylizer::graphics::webgpu {
	...
	inline WGPUVertexFormat to_webgpu(enum graphics::render_pipeline::config::vertex_buffer_layout::attribute::format format) {
		switch(format) {
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f32x1: return WGPUVertexFormat_Float32;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f32x2: return WGPUVertexFormat_Float32x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f32x3: return WGPUVertexFormat_Float32x3;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f32x4: return WGPUVertexFormat_Float32x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f16x2: return WGPUVertexFormat_Float16x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f16x4: return WGPUVertexFormat_Float16x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i32x1: return WGPUVertexFormat_Sint32;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i32x2: return WGPUVertexFormat_Sint32x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i32x3: return WGPUVertexFormat_Sint32x3;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i32x4: return WGPUVertexFormat_Sint32x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i16x2: return WGPUVertexFormat_Sint16x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i16x4: return WGPUVertexFormat_Sint16x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i16x2_normalized: return WGPUVertexFormat_Snorm16x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i16x4_normalized: return WGPUVertexFormat_Snorm16x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i8x2: return WGPUVertexFormat_Sint8x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i8x4: return WGPUVertexFormat_Sint8x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i8x2_normalized: return WGPUVertexFormat_Snorm8x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i8x4_normalized: return WGPUVertexFormat_Snorm8x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u32x1: return WGPUVertexFormat_Uint32;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u32x2: return WGPUVertexFormat_Uint32x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u32x3: return WGPUVertexFormat_Uint32x3;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u32x4: return WGPUVertexFormat_Uint32x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u16x2: return WGPUVertexFormat_Uint16x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u16x4: return WGPUVertexFormat_Uint16x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u16x2_normalized: return WGPUVertexFormat_Unorm16x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u16x4_normalized: return WGPUVertexFormat_Unorm16x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u8x2: return WGPUVertexFormat_Uint8x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u8x4: return WGPUVertexFormat_Uint8x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u8x2_normalized: return WGPUVertexFormat_Unorm8x2;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u8x4_normalized: return WGPUVertexFormat_Unorm8x4;
		case graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u10_10_10_2_normalized: return WGPUVertexFormat_Unorm10_10_10_2;
		default:
			STYLIZER_THROW(std::string("Failed to find attribute format: ") + std::string(magic_enum::enum_name(format)));
		}
	}
	inline enum graphics::render_pipeline::config::vertex_buffer_layout::attribute::format from_webgpu(WGPUVertexFormat format) {
		switch(format) {
		case WGPUVertexFormat_Float32: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f32x1;
		case WGPUVertexFormat_Float32x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f32x2;
		case WGPUVertexFormat_Float32x3: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f32x3;
		case WGPUVertexFormat_Float32x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f32x4;
		case WGPUVertexFormat_Float16x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f16x2;
		case WGPUVertexFormat_Float16x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::f16x4;
		case WGPUVertexFormat_Sint32: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i32x1;
		case WGPUVertexFormat_Sint32x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i32x2;
		case WGPUVertexFormat_Sint32x3: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i32x3;
		case WGPUVertexFormat_Sint32x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i32x4;
		case WGPUVertexFormat_Sint16x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i16x2;
		case WGPUVertexFormat_Sint16x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i16x4;
		case WGPUVertexFormat_Snorm16x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i16x2_normalized;
		case WGPUVertexFormat_Snorm16x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i16x4_normalized;
		case WGPUVertexFormat_Sint8x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i8x2;
		case WGPUVertexFormat_Sint8x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i8x4;
		case WGPUVertexFormat_Snorm8x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i8x2_normalized;
		case WGPUVertexFormat_Snorm8x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::i8x4_normalized;
		case WGPUVertexFormat_Uint32: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u32x1;
		case WGPUVertexFormat_Uint32x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u32x2;
		case WGPUVertexFormat_Uint32x3: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u32x3;
		case WGPUVertexFormat_Uint32x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u32x4;
		case WGPUVertexFormat_Uint16x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u16x2;
		case WGPUVertexFormat_Uint16x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u16x4;
		case WGPUVertexFormat_Unorm16x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u16x2_normalized;
		case WGPUVertexFormat_Unorm16x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u16x4_normalized;
		case WGPUVertexFormat_Uint8x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u8x2;
		case WGPUVertexFormat_Uint8x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u8x4;
		case WGPUVertexFormat_Unorm8x2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u8x2_normalized;
		case WGPUVertexFormat_Unorm8x4: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u8x4_normalized;
		case WGPUVertexFormat_Unorm10_10_10_2: return graphics::render_pipeline::config::vertex_buffer_layout::attribute::format::u10_10_10_2_normalized;
		default:
			STYLIZER_THROW(std::string("Failed to find attribute format: ") + std::string(magic_enum::enum_name(format)));
		}
	}

	inline WGPUStencilOperation to_webgpu(depth_stencil_attachment::stencil_config::face_state::operation op) {
		switch(op) {
		...
		default:
			STYLIZER_THROW(std::string("Failed to find face operation: ") + std::string(magic_enum::enum_name(op)));
		}
	}
	inline depth_stencil_attachment::stencil_config::face_state::operation from_webgpu(WGPUStencilOperation op) {
		switch(op) {
	...
	inline WGPUBlendOperation to_webgpu(enum blend_state::operation op) {
		switch (op) {
		...
		default:
			STYLIZER_THROW(std::string("Failed to find blend operation: ") + std::string(magic_enum::enum_name(op)));
		}
	}
	inline enum blend_state::operation from_webgpu(WGPUBlendOperation op) {
		switch (op) {
	...
	inline WGPUBlendFactor to_webgpu(enum blend_state::factor op) {
		switch(op){
		...
		default:
			STYLIZER_THROW(std::string("Failed to find blend factor: ") + std::string(magic_enum::enum_name(op)));
		}
	}
	inline enum blend_state::factor from_webgpu(WGPUBlendFactor op) {
		switch(op){
	...
	inline WGPUPrimitiveTopology to_webgpu(enum graphics::render_pipeline::config::primitive_topology topology) {
		switch (topology) {
		case graphics::render_pipeline::config::primitive_topology::PointList: return WGPUPrimitiveTopology_PointList;
		case graphics::render_pipeline::config::primitive_topology::LineList: return WGPUPrimitiveTopology_LineList;
		case graphics::render_pipeline::config::primitive_topology::LineStrip: return WGPUPrimitiveTopology_LineStrip;
		case graphics::render_pipeline::config::primitive_topology::TriangleList: return WGPUPrimitiveTopology_TriangleList;
		case graphics::render_pipeline::config::primitive_topology::TriangleStrip: return WGPUPrimitiveTopology_TriangleStrip;
		default:
			STYLIZER_THROW(std::string("Failed to find primitive topology: ") + std::string(magic_enum::enum_name(topology)));
		}
	}
	inline enum graphics::render_pipeline::config::primitive_topology from_webgpu(WGPUPrimitiveTopology topology) {
		switch (topology) {
		case WGPUPrimitiveTopology_PointList: return graphics::render_pipeline::config::primitive_topology::PointList;
		case WGPUPrimitiveTopology_LineList: return graphics::render_pipeline::config::primitive_topology::LineList;
		case WGPUPrimitiveTopology_LineStrip: return graphics::render_pipeline::config::primitive_topology::LineStrip;
		case WGPUPrimitiveTopology_TriangleList: return graphics::render_pipeline::config::primitive_topology::TriangleList;
		case WGPUPrimitiveTopology_TriangleStrip: return graphics::render_pipeline::config::primitive_topology::TriangleStrip;
		default:
			STYLIZER_THROW(std::string("Failed to find primitive topology: ") + std::string(magic_enum::enum_name(topology)));
		}
	}

	inline WGPUCullMode to_webgpu(enum graphics::render_pipeline::config::cull_mode mode){
		switch (mode) {
		case graphics::render_pipeline::config::cull_mode::Neither: return WGPUCullMode_None;
		case graphics::render_pipeline::config::cull_mode::Front: return WGPUCullMode_Front;
		case graphics::render_pipeline::config::cull_mode::Back: return WGPUCullMode_Back;
		case graphics::render_pipeline::config::cull_mode::Both: return WGPUCullMode_Undefined;
		default:
			STYLIZER_THROW(std::string("Failed to find culling mode: ") + std::string(magic_enum::enum_name(mode)));
		}
	}
	inline enum graphics::render_pipeline::config::cull_mode from_webgpu(WGPUCullMode mode){
		switch (mode) {
		case WGPUCullMode_None: return graphics::render_pipeline::config::cull_mode::Neither;
		case WGPUCullMode_Front: return graphics::render_pipeline::config::cull_mode::Front;
		case WGPUCullMode_Back: return graphics::render_pipeline::config::cull_mode::Back;
		case WGPUCullMode_Undefined: return graphics::render_pipeline::config::cull_mode::Both;
		default:
			STYLIZER_THROW(std::string("Failed to find culling mode: ") + std::string(magic_enum::enum_name(mode)));
		}
	}

	render_pipeline render_pipeline::create(graphics::device& device_, const pipeline::entry_points& entry_points, std::span<const color_attachment> color_attachments /* = {} */, const std::optional<depth_stencil_attachment>& depth_attachment /* = {} */, const render_pipeline::config& config /* = {} */, const std::string_view label /* = "Stylizer Graphics Pipeline" */) {
	...
	webgpu::bind_group render_pipeline::create_bind_group(graphics::device& device_, size_t index, std::span<const bind_group::binding> bindings, std::string_view label /* = "Stylizer Render Bind Group" */) {
		auto& device = confirm_webgpu_type<webgpu::device>(device_);
		return bind_group::internal_create(device, index, wgpuRenderPipelineGetBindGroupLayout(pipeline, index), bindings, label);
	}
	graphics::bind_group& render_pipeline::create_bind_group(temporary_return_t, graphics::device& device, size_t index, std::span<const bind_group::binding> bindings, std::string_view label /* = "Stylizer Render Bind Group" */) {
