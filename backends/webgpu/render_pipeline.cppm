...
namespace stylizer::graphics::webgpu {
	...
	WGPUVertexFormat to_webgpu(enum graphics::render_pipeline::config::vertex_buffer_layout::attribute::format format) {
		switch(format) {
	...
	enum graphics::render_pipeline::config::vertex_buffer_layout::attribute::format from_webgpu(WGPUVertexFormat format) {
		switch(format) {
	...
	WGPUPrimitiveTopology to_webgpu(enum graphics::render_pipeline::config::primitive_topology topology) {
		switch (topology) {
	...
	enum graphics::render_pipeline::config::primitive_topology from_webgpu(WGPUPrimitiveTopology topology) {
		switch (topology) {
	...
	WGPUCullMode to_webgpu(enum graphics::render_pipeline::config::cull_mode mode){
		switch (mode) {
	...
	enum graphics::render_pipeline::config::cull_mode from_webgpu(WGPUCullMode mode){
		switch (mode) {
