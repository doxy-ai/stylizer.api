...
export module stylizer.graphics.stub:shader;
...
namespace stylizer::graphics::stub {
	...
	export struct shader : public graphics::shader { STYLIZER_GRAPHICS_GENERIC_AUTO_RELEASE_SUPPORT(shader); STYLIZER_GRAPHICS_MOVE_TEMPORARY_TO_HEAP_DERIVED_METHOD(shader);
		...
		static stub::shader create_from_wgsl(graphics::device& device, const std::string_view wgsl, const std::string_view label = "Stylizer Shader") { STYLIZER_THROW("Not implemented yet!"); }
		static stub::shader create_from_session(graphics::device& device, shader::stage stage, slcross::session session, const std::string_view entry_point = "main", const std::string_view label = "Stylizer Shader") { STYLIZER_THROW("Not implemented yet!"); }
		static stub::shader create_from_spirv(graphics::device& device, shader::stage stage, spirv_view spirv, const std::string_view entry_point = "main", const std::string_view label = "Stylizer Shader") { STYLIZER_THROW("Not implemented yet!"); }
		static stub::shader create_from_source(graphics::device& device, language lang, shader::stage stage, const std::string_view source, const std::string_view entry_point = "main", const std::string_view label = "Stylizer Shader") { STYLIZER_THROW("Not implemented yet!"); }
