...
#  endif
			...
			return out;
#else
			throw error("Emscripten surfaces not supported!");
#endif
		}
...
#  endif
			...
			return out;
#else
			throw error("Cocoa surfaces not supported!");
#endif
		}
...
#  endif
			...
			return out;
#else
			throw error("X11 surfaces not supported!");
#endif
		}
...
#  endif
			...
			return out;
#else
			throw error("Wayland surfaces not supported!");
#endif
		}
...
#  endif
			...
			return out;
#else
			throw error("Win32 surfaces not supported!");
#endif
		}
