...
export module stylizer.graphics.glfw;

import std.compat;
import stylizer.errors;
import stylizer.graphics;

export namespace stylizer::graphics::glfw {

	constexpr bool is_available = true;
...
Tsurface create_surface(GLFWwindow* window) {
	...
	std::pair<Tdevice, Tsurface> create_surface_and_device(GLFWwindow* window, graphics::device::create_config device_config = {}) {
